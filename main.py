...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, required=True, help='Dataset to use.', choices=["ntu_rgbd_120", 'ntu_rgbd_60', 'ntu_rgbd_60_view1', 'ntu_rgbd_60_view2', 'ntu_rgbd_60_view3', "pkummd",  'mergedntupk', 'numa_cs', 'numa_cv', 'numa_view'])
